...
path-based LLaVA JSONL records consumable by ds/src/train/train_bimba_motion.py.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Convert a local HF/parquet video dataset to LLaVA JSONL.")
